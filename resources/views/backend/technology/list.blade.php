                        ...
                        <div class="ms-auto">
                            <div class="btn-group">
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                    data-bs-target="#categorymodel"><i class="bx bxs-plus-square"></i>Add Technology</button>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="product-img">
                                            ...
                                            <img src="{{asset('storage/technology')}}/{{$cat->thumbnail}}" alt="">
                                        </div>
                                    </td>
                                    <td>{{ $cat->name }}</td>
                                    <td>
                                        <div class="d-flex order-actions">
                                            ...
                                            <form method="post"
                                                action="{{ route('admin.technologyDestroy', ['id' => $cat->id]) }}">
                                                @csrf
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" enctype="multipart/form-data" action="{{ route('admin.technologyStore') }}">
                    {{ csrf_field() }}
                    <div class="row">
                        <div class="col-lg-12">
...
<div class="modal fade" id="LanguagemodelEdit1" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" enctype="multipart/form-data" action="{{route('admin.technologyUpdate')}}">
                    {{ csrf_field() }}
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="row g-1">
