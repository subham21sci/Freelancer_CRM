...
@section('title', 'Technology Category')
@section('css_Section')
@stop
@section('content')
    ...
    <div class="page-content">
        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-10">
                        <h3>Technology Category List</h3>
                    </div>
                    ...
                    <table id="example2" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            @php
                                $sl = 1;
                            @endphp
                            @foreach ($technologycatlist as $cat)
                                <tr>
                                    <td>{{ $sl++ }}</td>
                                    <td>{{ $cat->name }}</td>
                                    <td>
                                        <div class="d-flex order-actions">
                                            <a href="javascript:void(0)"  data-id="{{$cat->id}}" data-name="{{$cat->name}}" class="open-EditLangDialog act"><i
                                                class='bx bxs-edit '></i></a>

                                            <form method="post"
                                                action="{{ route('admin.technologycategoryDestroy', ['id' => $cat->id]) }}">
                                                @csrf
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Add technology category</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form method="POST" enctype="multipart/form-data" action="{{ route('admin.technologycategoryStore') }}">
                    {{ csrf_field() }}
                    <div class="row">
                        <div class="col-lg-12">
...
<div class="modal fade" id="LanguagemodelEdit1" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Edit technology category</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form method="POST" enctype="multipart/form-data" action="{{route('admin.technologycategoryUpdate')}}">
                    {{ csrf_field() }}
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="row g-1">
