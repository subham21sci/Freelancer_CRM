                                        ...
                                        <td>
                                            <div class="d-flex order-actions">
                                                <a href="javascript:void(0)" data-id="{{ $cat->id }}"
                                                    data-name="{{ $cat->name }}" class="openEditCategory act"><i
                                                        class='bx bxs-edit '></i></a>

                                                <form method="post"
                                                    action="{{ route('admin.category.catDestroy', ['id' => $cat->id]) }}">
                                                    @csrf
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" enctype="multipart/form-data" action="{{ route('admin.category.catStore') }}">
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="col-lg-12">
    ...
    <div class="modal fade" id="categoryEditModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" enctype="multipart/form-data" action="{{ route('admin.category.catUpdate') }}">
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="row g-1">
