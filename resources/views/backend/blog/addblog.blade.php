            ...
            <div class="card">
                <div class="card-body p-4">
                    <div class="form-body mt-4">
                        <form method="POST" enctype="multipart/form-data" action="{{ route('admin.blogStore') }}">
                            @csrf
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="row g-3 needs-validation" novalidate="">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" value="{{ old('meta_tags') }}" class="form-control"
                                                name="meta_tags">
...
@section('js_section')
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#addBlogBtn").closest("form").on("submit", function() {
                var btn = $("#addBlogBtn");
